...
<div class="grid grid-cols-10 gap-x-gap leading-relaxed">
	{#each cols as col}
		<div class="col-span-8 lg:col-span-4">
			{#each col as { role, children }}
				{#each children as member, i}
					<div class="grid grid-cols-5 gap-x-gap">
						<div class="col-span-2 text-right lg:col-span-2">
							{#if i == 0}
								<div>{role.name}</div>
							{/if}
						</div>
						<div class="col-span-10 flex gap-0.5 lg:col-span-3">
